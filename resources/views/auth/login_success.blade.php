        ...
        <div class="content-wrapper">
            <div class="promo-container">
                <div class="promo-text">
                    Welcome to Oppasabuy! Shop with confidence, we care about your trust. Claim this exclusive voucher for first-time users only.
                </div>
            ...
            <div class="login-card-container">
                <div class="login-card">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <button type="submit" class="btn-login" style="border: 1px solid #ccc; background: transparent; height: 35px; border-radius: 5px;">
                            </button>
